    ...
    return (
        <div>
            ...
            <div className="container centered-text">
                ...
                <p className="custom-color"> Repeated, disturbing<span className="italics not-bold"> dreams </span>of a stressful<br />experience from the past?</p>
            ...
            <a href="/self-assessment/question-1" className="previous-button">&lt; Previous</a>
            <a href="/self-assessment/question-3" className="next-button">Next &gt;</a>

            <div className="footer-question">
                <div className="page-count">Page 2 of 17</div>
            </div>
        </div>
    );
};
